...
shutil.copy2(python_src_directory + "/SonyBayerFilterConversion.py",
             projects_directory_location + "/SonyBayerFilterConversion.py")
...
if start_from_step == 0:
    ...
    fdtd_hook.setnamed(design_efield_monitor['name'], 'frequency points', num_design_frequency_points)
    ...
    for adj_src in range(0, num_adjoint_sources):
        ...
        fdtd_hook.setnamed(focal_monitor['name'], 'frequency points', num_design_frequency_points)
    ...
    for adj_src in range(0, num_adjoint_sources):
        ...
        fdtd_hook.setnamed(transmission_monitor['name'], 'frequency points', num_design_frequency_points)
