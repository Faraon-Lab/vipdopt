...
if slurm_job_env_variable is None:
    ...
    # raise ValueError('Environment variable does not exist - running on local machine.')
else: running_on_local_machine = False
...
if running_on_local_machine:
    # projects_directory_location_init = r"C:\Users\Ian\Dropbox\Caltech\Faraon Group\Simulations\Sony Bayer\[v2] divAng13_reoptimization\dev\divAng13_th10"
...
num_sidewalls = 4
sidewall_thickness_um = 0.06
sidewall_material = 'PEC (Perfect Electrical Conductor)'
