...
if __name__ == '__main__':
    ...
    FoM_1 = MSEFoM()
    FoM_1.set_target_2d_gaussian(arr_shape=project.device.size, N=9, std=2, center_point=(6,6))
    FoM_2 = MSEFoM()
    FoM_2.set_target_2d_gaussian(arr_shape=project.device.size, N=9, std=2, center_point=(18,18))
