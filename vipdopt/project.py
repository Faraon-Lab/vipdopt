...
class Project:
    ...
    def _setup_weights(self, cfg: Config):
        ...
        # )
        spectral_weights_by_fom = np.zeros(
            (cfg['num_bands'], cfg['num_design_frequency_points'])
        )
